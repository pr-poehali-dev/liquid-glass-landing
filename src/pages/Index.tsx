...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink via-lavender to-mint">
      <header className="fixed top-0 left-0 right-0 z-50 glass-card mx-2 sm:mx-4 mt-2 sm:mt-4">
        <div className="container mx-auto px-3 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Icon name="Flower2" size={28} className="text-primary sm:w-8 sm:h-8" />
              <span className="text-xl sm:text-2xl font-bold text-primary">Флора</span>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <a href="tel:+79991234567" className="md:hidden p-2">
                <Icon name="Phone" size={20} className="text-primary" />
              </a>
              <Button size="sm" className="rounded-full text-xs sm:text-sm px-3 sm:px-4">
                <Icon name="ShoppingCart" size={16} className="md:hidden" />
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="space-y-6 sm:space-y-8 animate-fade-in">
              <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold leading-tight text-foreground">
                Ваш идеальный букет
                <span className="block text-primary">с доставкой</span>
              </h1>
              <p className="text-base sm:text-xl text-muted-foreground max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <Button size="lg" variant="outline" className="rounded-full px-8 glass w-full sm:w-auto">
            ...
            <div className="relative animate-scale-in">
              <div className="glass-card p-4 sm:p-8 animate-float">
                <img
              ...
              <div className="absolute -bottom-4 sm:-bottom-6 -right-4 sm:-right-6 w-24 sm:w-40 h-24 sm:h-40 bg-primary/20 rounded-full blur-3xl -z-10" />
              <div className="absolute -top-4 sm:-top-6 -left-4 sm:-left-6 w-24 sm:w-40 h-24 sm:h-40 bg-lavender rounded-full blur-3xl -z-10" />
            </div>
          </div>
        </div>
      </section>
              ...
              >
                <CardContent className="p-3 sm:p-6 text-center space-y-2 sm:space-y-3">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto bg-primary/10 rounded-2xl flex items-center justify-center">
                    <Icon name={item.icon} size={24} className="text-primary sm:w-8 sm:h-8" />
                  </div>
                  <h3 className="font-semibold text-sm sm:text-lg text-foreground">{item.title}</h3>
      ...
      <section id="catalog" className="py-12 sm:py-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-8 sm:mb-16 space-y-3 sm:space-y-4">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground">Наши коллекции</h2>
              ...
              >
                ...
                <CardContent className="p-4 sm:p-6 space-y-3 sm:space-y-4">
                  <div className="space-y-1 sm:space-y-2">
                    <h3 className="text-lg sm:text-xl font-semibold text-foreground">{bouquet.name}</h3>
                    <p className="text-xl sm:text-2xl font-bold text-primary">{bouquet.price}</p>
                  </div>
                  <Button className="w-full rounded-full text-sm" variant="outline">
      ...
      <section id="about" className="py-12 sm:py-20 px-4">
        <div className="container mx-auto">
          <div className="glass-card p-6 sm:p-12 max-w-4xl mx-auto text-center space-y-4 sm:space-y-6">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground">Наша история</h2>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-8 pt-6 sm:pt-8">
              <div className="space-y-1 sm:space-y-2">
                <div className="text-2xl sm:text-4xl font-bold text-primary">10+</div>
                <div className="text-muted-foreground text-xs sm:text-base">лет опыта</div>
              </div>
              <div className="space-y-1 sm:space-y-2">
                <div className="text-2xl sm:text-4xl font-bold text-primary">5000+</div>
                <div className="text-muted-foreground text-xs sm:text-base">довольных клиентов</div>
              </div>
              <div className="space-y-1 sm:space-y-2">
                <div className="text-2xl sm:text-4xl font-bold text-primary">100%</div>
                <div className="text-muted-foreground text-xs sm:text-base">свежие цветы</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-8 sm:mb-16 space-y-3 sm:space-y-4">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground">Что говорят наши клиенты</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
      ...
      <footer className="py-8 sm:py-12 px-4 glass-card mx-2 sm:mx-4 mb-2 sm:mb-4">
        <div className="container mx-auto">
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              <h4 className="font-semibold text-sm sm:text-base text-foreground">Навигация</h4>
            ...
            <div className="space-y-3 sm:space-y-4 sm:col-span-2 md:col-span-1">
              <h4 className="font-semibold text-sm sm:text-base text-foreground">Социальные сети</h4>
          ...
          <div className="pt-6 sm:pt-8 border-t border-border text-center text-muted-foreground">
            <p className="text-xs sm:text-sm">© 2024 Флора. Все права защищены.</p>
          </div>
        </div>
      </footer>
    </div>
